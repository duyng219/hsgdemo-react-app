...
import { createPlasticPipe } from "../../../redux/slices/plasticPipeSlice";
import { notiFunc } from "../../../utils/settings/notification/notiFunc";

const AddNewPlasticPipe = () => {
  ...
  const handleCreate = (e) => {
    e.preventDefault();
    dispatch(createPlasticPipe(inputValue));
  };
...
export default AddNewPlasticPipe;
