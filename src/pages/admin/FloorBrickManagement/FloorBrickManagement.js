...
const FloorBrickManagement = () => {
      ...
      render: (text, record) => {
        return (
          <div>
            ...
            <NavLink to={`/admin/floorBrick/update-floorBrick/${record.id}`}>
  ...
  return <Table rowKey="id" dataSource={floorBrickList} columns={columns} />;
};

export default FloorBrickManagement;
