...
import { createInteriorBrick } from "../../../redux/slices/interiorBrickSlice";
import { notiFunc } from "../../../utils/settings/notification/notiFunc";

const AddNewInteriorBrick = () => {
  ...
  const handleCreate = (e) => {
    e.preventDefault();
    dispatch(createInteriorBrick(inputValue));
  };
...
export default AddNewInteriorBrick;
