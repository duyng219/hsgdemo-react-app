...
import { createConstructionSteel } from "../../../redux/slices/constructionSteelSlice";
import { notiFunc } from "../../../utils/settings/notification/notiFunc";

const AddNewConstructionSteel = () => {
  ...
  const handleCreate = (e) => {
    e.preventDefault();
    dispatch(createConstructionSteel(inputValue));
  };
...
export default AddNewConstructionSteel;
