...
const UpdateInteriorPaint = () => {
  ...
  const handleUpload = async (e) => {
    ...
    const storageRef = ref(
      storage,
      `/hoasen/images/interiorPaint/${file.name}`
    );
  ...
  useEffect(() => {
    dispatch(getOneInteriorPaint(id));
    setInputValue({
      name: interiorPaint.name,
      price: interiorPaint.price,
      image: interiorPaint.image,
    });
    setUrlImage(interiorPaint.image);
  }, [
    dispatch,
    id,
    interiorPaint.name,
...
export default UpdateInteriorPaint;
