...
const InteriorPaintManagement = () => {
      ...
      render: (text, record) => {
        return (
          <div>
            ...
            <NavLink
              to={`/admin/interiorPaint/update-interiorPaint/${record.id}`}
            >
  ...
  return <Table rowKey="id" dataSource={interiorPaintList} columns={columns} />;
};

export default InteriorPaintManagement;
