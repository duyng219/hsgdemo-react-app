...
import { createInteriorPaint } from "../../../redux/slices/interiorPaintSlice";
import { notiFunc } from "../../../utils/settings/notification/notiFunc";

const AddNewInteriorPaint = () => {
  ...
  const handleCreate = (e) => {
    e.preventDefault();
    dispatch(createInteriorPaint(inputValue));
  };
...
export default AddNewInteriorPaint;
